const appData = {
    "header": {
        "title": "Мультиагентная система маршрутизации самолетов в воздушном пространстве",
        "subtitle": "Моделирование и динамическая оптимизация траекторий полетов ВС с учетом погодных, навигационных и эксплуатационных факторов",
